...
<main>
	<div class="lg:w-1/2 w-10/12 border rounded mx-auto my-24 flex flex-col">
        ...
        <button class="bg-white hover:border-green-300 text-gray-800 font-semibold py-2 px-4 border border-gray-400 w-fill rounded self-center mb-5 text-sm lg:text-lg" >Log In</button>
	</div>
</main>
